...
<body style="background:#333333;">
	...
	<div class="container mb-5">
		<div class="card mb-5" style="border: black solid; border-radius: 25px">
			<div class="row g-0">
							...
							<div class="d-flex">
								<div style="width: 300px;">
									...
									<p style="font-size: 16px;">
										<i class="fas fa-car"  style="color:white"></i> Used Car
									</p>
								</div>
		...
		<c:if test="${not empty bid}">
			<div class="row" style="color:white;">
				...
				<div class="col-12">
					<table style="border-radius: 30px; border: black solid">
						<thead>
