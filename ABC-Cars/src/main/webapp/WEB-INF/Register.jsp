...
<body style="background:#333333">
	...
	<div style="right:-35%;position:relative; background-color:gray; color:white; border-radius:25px; border:white solid; max-width:600px;padding: 50px 30px 10px; margin: 45px 0 0 0;">
